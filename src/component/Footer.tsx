                ...
                >
                    <form onSubmit={handleSubmit} className="w-full max-w-2xl">
                        <div className="flex flex-col sm:flex-row gap-4">
                            ...
                            <button
                                type="submit"
                                className="px-8 py-4 bg-white text-gray-400 font-semibold rounded-lg hover:bg-gray-100 transition-colors duration-300 shadow-lg hover:shadow-xl whitespace-nowrap"
                            >
                                Get Started Free
                            </button>
                        </div>
...
export function Footer() {
    return (
        <footer className="bg-cyan-700 text-gray-300 pt-16 pb-8">
            <div className="container mx-auto px-4">
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
                    <div>
                        <h3 className="text-white text-xl font-bold mb-6 flex items-center">
                            <span className="text-yellow-400">Book</span>Eclub
                        </h3>
                        <p className="mb-4">
                ...
                <div className="border-t border-b-blue-600 mt-12 pt-8 flex flex-col md:flex-row justify-between items-center">
                    <p className="text-gray-400 text-sm mb-4 md:mb-0">
                        &copy; {new Date().getFullYear()} Eclub. All rights reserved.
                    </p>
